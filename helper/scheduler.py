...
def runScheduler():
    ...
    scheduler.add_job(__runProxyFetch, 'interval', minutes=1, id="proxy_fetch", name="proxy采集")
    scheduler.add_job(__runProxyCheck, 'interval', minutes=0.2, id="proxy_check", name="proxy检查")
    executors = {
